...
def generate_launch_description():
    ...
    add_launch_arg(
        ...
        [
            ...
            "/config/localization/crop_box_filter_measurement_range.param.yaml",
        ],
        "path to the parameter file of crop_box_filter_measurement_range",
    )
    add_launch_arg(
        "voxel_grid_downsample_filter_param_path",
        [FindPackageShare("nightowl_launch"), "/config/localization/voxel_grid_filter.param.yaml"],
    ...
    add_launch_arg(
        ...
        [
            FindPackageShare("nightowl_launch"),
            "/config/localization/random_downsample_filter.param.yaml",
        ],
    ...
    add_launch_arg(
        "container",
        "/sensing/lidar/top/pointcloud_preprocessor/lslidar_container",
        "container name",
    )
    add_launch_arg(
        "input/pointcloud",
